...
import com.kh.spring.util.tamplate.Pagination;
...
public class BoardServiceImple implements BoardService{
	...
	public void insertBoard(BoardDTO board, MultipartFile file, HttpSession session) {
		...
		if(!file.getOriginalFilename().isEmpty()) {
			...
			String savePath = application.getRealPath("/resources/upload_file/");
			...
			board.setChangeName("/sping/resources/upload_file/" + sb.toString());
		}
