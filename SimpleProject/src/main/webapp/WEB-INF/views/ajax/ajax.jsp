...
<body>
	...
	<button onclick="selectReply()">게시글 보기</button>
		...
		function selectReply(){
			...
			$.ajax({
				...
				success : result => {
					...
					document.querySelector('#date').innerText = result.boardDate;
					...
					const elements = reply.map(e =>{
						...
						<div>
							...
							<label style="width:180px;">작성일 : \${e.replyDate}</label>
						</div>
						`)
					}).join('');
