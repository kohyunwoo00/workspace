...
<body>
	...
	<pre>
		...
		* 동기식 / 비동기식 요청 차이
		...
		- 비동기식 : 현제 페이지는 그대로 유지하면서 중간중간 주가적인 요청을 보낼 수 있음
	...
	*/
	...
	<div class="form-group">
		...
		<div class="form-control">
			<button calss="btn btn-sm btn-primary" id="ajax-btn">AJAX로 요청보내기</button>
		</div>
	</div>
